...
# 'removeDuplicates.emepdata'. WHILE THE FIRST ONE ONLY COMPARES THE short 
...
#' @format R Code
#' @export 
removeDuplicates.emepdata <- function(emepdata, removeList=findDuplicates.emepdata(emepdata)) {
